                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-1 text-gray-500">+91 123 456 7890</p>
                                        <p className="mt-1 text-gray-500">+91 098 765 4321</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-1 text-gray-500">tnp@university.edu</p>
                                        <p className="mt-1 text-gray-500">support@university.edu</p>
                                    </div>
                                </div>
                            </div>
                        </div>
