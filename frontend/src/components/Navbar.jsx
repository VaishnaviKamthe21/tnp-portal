...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f0f0ee]/95 backdrop-blur-md border-b border-gray-200/60">
                    ...
                    <div className="md:hidden py-4 border-t border-gray-200">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-col gap-2 mt-4 px-4">
                                <Link
                                    to="/admin/jobs"
                                    className="w-full px-4 py-3 text-sm font-medium text-center text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                                    onClick={() => setIsOpen(false)}
                                >
                                    Post a Job
                                </Link>
                                <Link
                                    to="/student/jobs"
                                    className="w-full px-4 py-3 text-sm font-medium text-center text-white bg-gray-900 rounded-lg transition-all"
                                    onClick={() => setIsOpen(false)}
                                >
                                    Want a Job
                                </Link>
